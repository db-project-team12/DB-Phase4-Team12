    ...
    <form action="<%=request.getContextPath()%>/auth/signup" method="post">
        ...
        <div class="form-group">
            ...
            <select id="grade" name="grade" required>
                ...
                <option value="1" <%= "1".equals(request.getAttribute("grade")) ? "selected" : "" %>>1학년</option>
                <option value="2" <%= "2".equals(request.getAttribute("grade")) ? "selected" : "" %>>2학년</option>
                <option value="3" <%= "3".equals(request.getAttribute("grade")) ? "selected" : "" %>>3학년</option>
                <option value="4" <%= "4".equals(request.getAttribute("grade")) ? "selected" : "" %>>4학년</option>
            </select>
        </div>
